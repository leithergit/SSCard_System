...
void uc_FaceCapture::OnLiveDetectStatusEvent(int eventID, int nFrameStatus)
{
    ...
    if (eventID == 1)
    {
        ...
        gInfo() << QString(u8"准备生成临时文件:%1").arg(strFaceImageFile).toLocal8Bit().data();
    ...
    else if (eventID == 0)
    {
        ...
        {
        case 1:
            strEvent = u8"活体检测正在进行:没有检测到人脸";
            break;
        case 2:
            strEvent = u8"活体检测正在进行:人脸超出蒙层";
            break;
        case 3:
            strEvent = u8"活体检测正在进行:人脸角度不对、属于低头， 抬头， 左右转情况";
            break;
        case 4:
            strEvent = u8"活体检测正在进行:人脸太大";
            break;
        case 5:
            strEvent = u8"活体检测正在进行:人脸太小";
            break;
        case 6:
            strEvent = u8"活体检测正在进行:人脸靠近边界";
            break;
        case 7:
            strEvent = u8"活体检测正在进行:额头被遮挡";
            break;
        case 8:
            strEvent = u8"活体检测正在进行:眼睛被遮挡";
            break;
        case 9:
            strEvent = u8"活体检测正在进行:嘴巴被遮挡";
            break;
        case 10:
            strEvent = u8"活体检测正在进行:人脸质量不合格";
            break;
        case 11:
            strEvent = u8"活体检测正在进行:非活体";
            break;
        default:
            break;
        }
