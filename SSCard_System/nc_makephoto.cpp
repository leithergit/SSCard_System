...
nc_MakePhoto::nc_MakePhoto(QLabel* pTitle, QString strStepImage, Page_Index nIndex, QWidget* parent) :
    ...
    ui(new Ui::nc_MakePhoto)
{
    ui->setupUi(this);
    connect(this, &nc_MakePhoto::FaceCaptureSucceed, this, &nc_MakePhoto::OnFaceCaptureSucceed);
    connect(this, &nc_MakePhoto::FaceCaptureFailed, this, &nc_MakePhoto::OnFaceCaptureFailed);
}

nc_MakePhoto::~nc_MakePhoto()
{
    ShutDownDevice();
    delete ui;
}

void  nc_MakePhoto::ShutDownDevice()
{
    QString strError;
...
int nc_MakePhoto::ProcessBussiness()
{
...
void nc_MakePhoto::OnTimeout()
{
    //ShutDownDevice();
    ShutDown();
}

int nc_MakePhoto::OpenCamara(QString& strError)
{
    int nResult = 0;
    do
    {
...
int nc_MakePhoto::CloseCamera(QString& strError)
{
    int nResult = 0;
    do
    {
...
void  nc_MakePhoto::OnFaceCaptureSucceed()
{
    QString strError;
    m_pFaceDetectOcx->EndLiveDectection();
...
void nc_MakePhoto::OnFaceCaptureFailed()
{
    QString strError;
    m_pFaceDetectOcx->EndLiveDectection();
    m_bDetectionStart = false;
...
int  nc_MakePhoto::SaveImage(QString& strFaceImageFile, QString& strMessage, int nFull)
{
...
int  nc_MakePhoto::GetFaceCaptureStorePath(QString& strFilePath, int nFull)
{
...
void nc_MakePhoto::OnLiveDetectStatusEvent(int eventID, int nFrameStatus)
{
