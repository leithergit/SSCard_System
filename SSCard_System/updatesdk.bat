...
copy /y ..\sdk.git\Printer\KT_Printer\%1\*.lib	.\SDK\KT_Printer
copy /y ..\sdk.git\Printer\KT_Printer\%1\*.dll	.\SDK\KT_Printer

@echo update Reader Driver...
copy /y ..\sdk.git\Reader\KT_Reader\KT_Reader\KT_Reader.h	.\SDK\KT_Reader
copy /y ..\sdk.git\Reader\KT_Reader\%1\*.lib	.\SDK\KT_Reader
copy /y ..\sdk.git\Reader\KT_Reader\%1\*.dll	.\SDK\KT_Reader

@echo update SSCardDriver...
copy /y ..\sdk.git\sscarddriver\SSCardDriver\SSCardDriver\SSCardDriver.h .\SDK\SSCardDriver

copy /y ..\sdk.git\sscarddriver\SSCardDriver\%1\*.lib  .\SDK\SSCardDriver
copy /y ..\sdk.git\sscarddriver\SSCardDriver\%1\*.dll  .\SDK\SSCardDriver

@echo update SSCardHSM...
copy /y ..\sdk.git\sscardhsm\SSCardHSM\SSCardHSM\KT_SSCardHSM.h .\SDK\SSCardHSM
copy /y ..\sdk.git\sscardhsm\SSCardHSM\%1\*.lib .\SDK\SSCardHSM
copy /y ..\sdk.git\sscardhsm\SSCardHSM\%1\*.dll .\SDK\SSCardHSM
...
copy /y ..\sdk.git\SSCardInfo\SSCardInfo\%1\*.lib .\SDK\SSCardInfo_Henan
copy /y ..\sdk.git\SSCardInfo\SSCardInfo\%1\*.dll .\SDK\SSCardInfo_Henan

@echo update SD_SSCardInfo...
copy /y ..\sdk.git\sd_sscardinfo\SD_SSCardInfo\SD_SSCardInfo\SD_SSCardInfo.h .\SDK\SSCardinfo_Sandong
copy /y ..\sdk.git\sd_sscardinfo\SD_SSCardInfo\%1\*.lib .\SDK\SSCardinfo_Sandong
copy /y ..\sdk.git\sd_sscardinfo\SD_SSCardInfo\%1\*.dll .\SDK\SSCardinfo_Sandong
